...
const CenteredBlockWithImage: React.FC = () => {
  return (
    <div className="relative flex h-3/5 w-1/2 rounded-3xl border-4 border-slate-300 bg-white p-8 shadow-lg">
      ...
      <div className="absolute -bottom-8 -left-8 h-48 w-48 overflow-hidden rounded-full border-4 border-slate-300 shadow-md">
        <img
